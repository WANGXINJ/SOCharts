...
public class GaugeChart extends AbstractDataChart implements HasPolarProperty {
	...
	/**
	 * Set the current value. If there are more than one needle, value for the first
	 * needle will be set.
	 *
	...
	/**
	 * Get the current value. If there are more than one needle, value for the first
	 * needle will be returned.
	 *
	 * @return Value.
	 */
