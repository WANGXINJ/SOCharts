...
/**
 * Funnel chart. (Future versions will provide more chart-specific methods).
 *
 * @author Syam
 */
public class FunnelChart extends SelfPositioningChart {
	...
	/**
	 * Set the tail size. (Default value of tail size is zero and thus, the tail
	 * will look like a triangle).
	 *
	...
	/**
	 * Invert the view of the slices. (By default, the slices are sorted in
	 * descending order. By setting this to <code>true</code>, slices will be shown
	 * in ascending order).
	 *
