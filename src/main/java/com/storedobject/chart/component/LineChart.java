...
import com.storedobject.chart.property.PointSymbol;

/**
 * Line chart. (Future versions will provide more chart-specific methods).
 *
 * @author Syam
 */
public class LineChart extends XYChart {
	...
	/**
	 * Get the line-style. (If <code>true</code> is passed as the parameter, a new
	 * line-style will be created if not already exists).
	 *
	...
	/**
	 * Get the area-style (to style the area under the line). (If <code>true</code>
	 * is passed as the parameter, a new area-style will be created if not already
	 * exists).
	 *
	 * @param create Whether to create it or not.
	 * @return Area-style.
