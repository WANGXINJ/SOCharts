 ...
 * {@link Toolbox}. A standard set of "toolbox buttons" are available as static
 * classes within {@link Toolbox}. However, support for "custom toolbox buttons"
...
public abstract class ToolboxButton implements ComponentPart {
	...
	/**
	 * Encode caption part here. The default implementation does the needful to
	 * handle the return value of {@link #getCaption()}.
	 *
