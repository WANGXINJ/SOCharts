...
import com.storedobject.chart.property.Padding;
import com.storedobject.chart.property.TextStyle;

/**
 * Representation of legend. A legend will be automatically displayed by the
 * {@link SOChart}. However, that can be turned off using
 * {@link SOChart#disableDefaultLegend()} and customized legends may be added
 * using {@link SOChart#add(Component...)}.
 *
 * @author Syam
 */
